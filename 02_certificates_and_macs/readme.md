...
Remember that textbook RSA is insecure and serves only for illustration, in practice use a
...
1. Choose a hostname using only RSA in their certificate chain and download the server certificate. We suggest `www.instagram.com`, since it has a simple chain of 3 RSA certificates. You
