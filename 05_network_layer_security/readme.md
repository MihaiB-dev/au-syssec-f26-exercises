...
```shell
ping 192.168.3.25                                                                                              3.11.9   

Pinging 192.168.3.25 with 32 bytes of data:
Reply from 192.168.3.25: bytes=32 time=16ms TTL=63
Reply from 192.168.3.25: bytes=32 time=2ms TTL=63
Reply from 192.168.3.25: bytes=32 time=7ms TTL=63
Reply from 192.168.3.25: bytes=32 time=165ms TTL=63

Ping statistics for 192.168.3.25:
    Packets: Sent = 4, Received = 4, Lost = 0 (0% loss),
Approximate round trip times in milli-seconds:
    Minimum = 2ms, Maximum = 165ms, Average = 47ms
```
